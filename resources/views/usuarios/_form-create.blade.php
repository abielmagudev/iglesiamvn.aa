...
<div class="field">
    ...
    <div class="control">
        <x-form.input type="password" id="passwordContrasena" class="input" name="password" required />
    </div>
...
<div class="field">
    ...
    <div class="control">
        <x-form.input type="password" id="passwordConfirmarContrasena" class="input" name="password_confirmation" required />
    </div>
